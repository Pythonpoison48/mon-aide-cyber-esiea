...
\addto\captionsfrench{%
	\renewcommand{\contentsname}{\color{esieadarkblue}\sffamily Table des matières}%
}
\usepackage{lmodern}
\usepackage{geometry}
\usepackage{graphicx}
...
% Sections seulement dans le sommaire (pas les sous-sections)
\setcounter{tocdepth}{1}

% Style des entrées
\renewcommand{\cftsecfont}{\sffamily\bfseries\color{headerblue}}
\renewcommand{\cftsecpagefont}{\sffamily\bfseries\color{headerblue}}
...
\begin{document}
	...
	%--------------------------------------------------
	\section{Recommandations complémentaires — Non Technique}
